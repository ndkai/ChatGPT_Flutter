...
class Input extends StatefulWidget {
  ...
  const Input({
    ...
    this.onTextChanged,
    this.onTextFieldTap,
    required this.sendButtonVisibilityMode, required this.onSendImgPressed,
  }) : super(key: key);
  ...
  final void Function(types.PartialText) onSendImgPressed;
...
class _InputState extends State<Input> {
  ...
  void _handleSendImgPressed() {
    final trimmedText = _textController.text.trim();
    if (trimmedText != '') {
      final _partialText = types.PartialText(text: trimmedText);
      widget.onSendImgPressed(_partialText);
      _textController.clear();
    }
  }
                  ...
                  child: Row(
                    children: [
                      ...
                      Visibility(
                        ...
                        child: SendButton(
                          image: 'assets/chat_icon/gallery.png',
                          onPressed: _handleSendImgPressed,
                        ),
                      ),
                      Visibility(
                        visible: _sendButtonVisible,
                        child: SendButton(
                          image: 'assets/chat_icon/paper-plane.png',
